...
public class EstimationCommonUtil {
    ...
    public List<BillingSlab> getBillingSlabs(Property property, String financialYear, RequestInfo requestInfo) {
    ...
    public List<BillingSlab> getCommonSlabsFiltered(Property property, String financialYear, RequestInfo requestInfo) {
        PropertyDetail detail = property.getPropertyDetails().get(0);
        log.debug("Financial Year in Criteria: {}", financialYear);

        List<BillingSlab> billingSlabs = getBillingSlabs(property, financialYear, requestInfo);
    ...
    public Map<String, Object> getExemptionFromUsage(Unit unit, String financialYear,
    ...
    public BigDecimal getOwnerExemption(Set<OwnerInfo> owners, BigDecimal taxAmt, String financialYear,
                                        Map<String, Map<String, List<Object>>> propertyMasterMap) {
    ...
    public BillingSlab getCommonSlabForCalc(List<BillingSlab> billingSlabs, Unit unit) {
        final String all = configs.getSlabValueAll();
